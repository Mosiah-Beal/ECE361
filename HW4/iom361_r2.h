 ...
 *							Temp(degrees C) = (ST/20**20) * 200 - 50
...
/**
  ...
  * and the function will calculate the value written to the register
  *
  * This function adds the capability to set the temperature and humidity values
  * to random numbers within the specified range
  *
